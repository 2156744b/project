...
flineitem = filter lineitem by l_shipdate >= '1996-04-01' and l_shipdate < '1996-07-01';
...
store ord into '/apps/hive/warehouse/q15' USING  OrcStorage('|');
