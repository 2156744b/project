...
nation10 = LOAD '/apps/hive/warehouse/nation' USING OrcStorage('|') as (n_nationkey:int, n_name1:chararray, n_regionkey:int, n_comment:chararray);

nation20 = LOAD '/apps/hive/warehouse/nation' USING OrcStorage('|') as (n_nationkey:int, n_name2:chararray, n_regionkey:int, n_comment:chararray);
...
store ordered_shipping into '/apps/hive/warehouse/q7' USING OrcStorage('|');
