...
customer_filter = filter customer by c_acctbal>0.00 and SUBSTRING(c_phone, 0, 2) MATCHES '18|14|31|33|13|27|24';
...
customer_sec_filter = filter customer by c_acctbal > avg_customer_filter.avg_c_acctbal and SUBSTRING(c_phone, 0, 2) MATCHES '18|14|31|33|13|27|24';
...
store customer_result_inorder into '/apps/hive/warehouse/q22' USING OrcStorage('|');
