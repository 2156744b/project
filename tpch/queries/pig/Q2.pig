...
FPart = filter Part by p_size == 15 and p_type matches '.*TIN';
...
STORE HundredMinimumCostSupplier into '/apps/hive/warehouse/q2' USING OrcStorage('|');
