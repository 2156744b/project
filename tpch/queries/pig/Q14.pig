...
filtered_lineitem = filter lineitem by l_shipdate >= '1997-12-01' and l_shipdate < '1998-01-01';
...
store promo_revenue into '/apps/hive/warehouse/q14' USING OrcStorage('|');
