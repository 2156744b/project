...
forders = filter orders by o_orderdate < '1995-03-12';
flineitem = filter lineitem by l_shipdate > '1995-03-12';
...
store limitResult into '/apps/hive/warehouse/q3' USING OrcStorage('|');
