...
forders = filter orders by o_orderdate < '1994-06-01' and o_orderdate >= '1994-03-01';
...
store limitResult into '/apps/hive/warehouse/q10' USING OrcStorage('|');
