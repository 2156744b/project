rmf /apps/hive/warehouse/q1

LineItems = LOAD '/apps/hive/warehouse/lineitem' USING OrcStorage('|') AS (orderkey:long, partkey:long, suppkey:long, linenumber:long, quantity:double, extendedprice:double, discount:double, tax:double, returnflag, linestatus, shipdate, commitdate, receiptdate, shipinstruct, shipmode, comment);
SubLineItems = FILTER LineItems BY shipdate <= '1998-12-01';
...
STORE SortedSummary into '/apps/hive/warehouse/q1' USING OrcStorage('|');
