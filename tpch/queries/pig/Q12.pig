...
flineitem = FILTER lineitem BY l_shipmode MATCHES 'AIR|SHIP' AND
                   l_commitdate < l_receiptdate AND l_shipdate < l_commitdate AND
                   l_receiptdate >= '1996-01-01' AND l_receiptdate < '1997-01-01';
...
store sortResult into '/apps/hive/warehouse/q12' USING OrcStorage('|');
